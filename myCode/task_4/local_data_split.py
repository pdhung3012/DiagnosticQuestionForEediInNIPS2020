...
data = pd.read_csv(os.path.normpath('../data/train_data/train_task_3_4.csv'))
...
train_df.to_csv(os.path.normpath('../data/test_input/train_task_4.csv'), index=False)
valid_df.to_csv(os.path.normpath('../data/test_input/valid_task_4.csv'), index=False)
